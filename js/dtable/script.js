...
function GenDefs(){
    ...
    document.getElementById('Def').children[1].innerHTML += '<form><input type="text" placeholder="Row_To_Delete!" id="DelRow"><input type="button" onclick="Del_Row()" value="Delete_It!"></form><br>';
    document.getElementById('Def').children[0].innerHTML += '<input type="button" onclick="RandTheTable()" value="Magick!"><br><br>';
...
function Gen_Header() {
    document.getElementById('table').innerHTML += '<caption>Your_Created_Header!</caption>';
}
